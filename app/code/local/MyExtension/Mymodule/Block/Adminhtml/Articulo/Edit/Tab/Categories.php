 ...
 */
/**
 * articulo - categories relation edit block
 *
 * @category    MyExtension
 * @package     MyExtension_Mymodule
 * @author      Ultimate Module Creator
 */
class MyExtension_Mymodule_Block_Adminhtml_Articulo_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('myextension_mymodule/articulo/edit/tab/categories.phtml');
        $this->_withProductCount = false;
    }

    /**
     * Retrieve currently edited articulo
     *
     * @access public
    ...
    /**
     * Return array with categories IDs which the articulo is linked to
     *
     * @access public
     * @return array
     * @author Ultimate Module Creator
    ...
    public function getCategoryIds()
    {
        if (is_null($this->_categoryIds)) {
            $categories = $this->getArticulo()->getSelectedCategories();
            $ids = array();
     ...
     * Returns root node
     *
     * @param MyExtension_Mymodule_Model_Category|null $parentNodeCategory
