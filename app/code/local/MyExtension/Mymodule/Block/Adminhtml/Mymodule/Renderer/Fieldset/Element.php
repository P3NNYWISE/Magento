 ...
 */
class MyExtension_Mymodule_Block_Adminhtml_Mymodule_Renderer_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    {
        $this->setTemplate('myextension_mymodule/form/renderer/fieldset/element.phtml');
    }
     ...
     *
     * @access public
     * @return MyExtension_Mymodule_Model_Resource_Eav_Attribute
     * @author Ultimate Module Creator
     */
     ...
     *
     * @access public
     * @return MyExtension_Mymodule_Block_Adminhtml_Mymodule_Renderer_Fieldset_Element
     * @author Ultimate Module Creator
     */
    ...
    public function getScopeLabel()
    {
        ...
        if ($this->isScopeGlobal($attribute)) {
            $html.= Mage::helper('myextension_mymodule')->__('[GLOBAL]');
        } elseif ($this->isScopeWebsite($attribute)) {
            $html.= Mage::helper('myextension_mymodule')->__('[WEBSITE]');
        } elseif ($this->isScopeStore($attribute)) {
            $html.= Mage::helper('myextension_mymodule')->__('[STORE VIEW]');
        }
        return $html;
    }
