 ...
 */
class MyExtension_Mymodule_Model_Resource_Attribute extends Mage_Eav_Model_Resource_Entity_Attribute
{
    /**
     ...
     * @return  MyExtension_Mymodule_Model_Resource_Attribute
     * @author Ultimate Module Creator
     */
