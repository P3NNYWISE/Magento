 ...
 */
/**
 * Articulo comments resource collection model
 *
 * @category    MyExtension
 * @package     MyExtension_Mymodule
 * @author      Ultimate Module Creator
 */
class MyExtension_Mymodule_Model_Resource_Articulo_Comment_Articulo_Collection extends MyExtension_Mymodule_Model_Resource_Articulo_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('myextension_mymodule/articulo_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.articulo_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('myextension_mymodule/articulo_comment');
        $this->addAttributeToSelect('titulo');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.articulo_id = e.entity_id',
            array(
                'ct_title'      => 'title',
